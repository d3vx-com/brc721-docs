...
[![Video Tutorial on how to create a BRC721 collection](http://img.youtube.com/vi/wuNOa5rWYtM/0.jpg)](http://www.youtube.com/watch?v=wuNOa5rWYtM "BRC721: How to inscribe your first collection")
...
**Enough theory! Let's create our first collection.**

## Preparing wallet and keys

- Download and top up [OrdinalSafe wallet](https://ordinalsafe.xyz/) with at least 40000 SATS (0.0004BTC). It is the only wallet that supports BRC721 at this moment, more integrations are in the pipeline.

- Go to the [BRC721 Playground](https://brc721.com/playground) and generate your Public and Private(Secret) Keys.

  <img
    src="/img/generating-keys.png"
    alt="generating keys"
    className="showcase"
  />
...
<img
  src="/img/collection-manifest.png"
...
<img
  src="/img/ordinal-safe-collection-inscription.png"
...
<img
  src="/img/collection-tx-hash.png"
...
<img
  src="/img/find-collection-id.png"
...
<img
  src="/img/find-collection-id-update.png"
...
First, as the person creating the collection, we will start by inscribing a token for ourselves. This exact process will be replicated for each inscription related to the access list addresses, although those will typically include a value in the price field. For our particular situation, we'll leave the price field blank, enabling us to mint at no cost. However, if your intention is to sell the token, the price must be specified in SATS.
**_Important!_ The price must be higher than 546 SATS(e.g. >=547 SATS).**

<img
  src="/img/collection-owner-mint.png"
